    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-fit  flex justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        >
          ...
          <motion.button
            ...
            className="bg-blue-600 mb-16 sm:mb-24 md:mb-32 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base lg:text-lg font-semibold hover:bg-blue-700 transition-colors inline-flex items-center gap-2 shadow-lg"
          >
            View Open Positions
      ...
      <div className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">Why Join Us?</h2>
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-7 px-4 sm:px-6">
          {[
            {
            ...
            },
            {
              ...
              <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-gray-50 shadow-lg rounded-xl p-4 sm:p-6 lg:p-8 text-center hover:shadow-xl transition-shadow w-full max-w-sm"
              >
                <div className="text-blue-600 mb-3 sm:mb-4 flex justify-center">{item.icon}</div>
      ...
      <div className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">Open Positions</h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto px-4">Find your perfect role from our current openings</p>
          </motion.div>
          ...
          <div className="space-y-6">
            {[
              ...
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-white rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-200"
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4">
                  ...
                  <motion.button
                    ...
                    className="mt-3 sm:mt-4 md:mt-0 bg-blue-600 text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base shadow-sm hover:shadow-md"
                  >
                    Apply Now
                  </motion.button>
                </div>
      ...
      {popup.show && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-xl p-4 sm:p-6 max-w-sm sm:max-w-md w-full shadow-2xl m-4"
